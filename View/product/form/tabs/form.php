                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="productname" name="product[productName]" value="<?php echo $product->productName ?>" type="text" placeholder="PRODUCT NAME" class="validate form-control">
                        </div>

                        <div class="form-group col-md-4">
                            <label for="price">PRICE</label>
                            <input id="price" name="product[productPrice]" value="<?php echo $product->productPrice ?>" type="text" placeholder="PRODUCT PRICE" class="validate form-control" require>
                        </div>

                        <div class="form-group col-md-4">
                            <label for="discount">DISCOUNT</label>
                            <input id="discount" name="product[productDiscount]" value="<?php echo $product->productDiscount ?>" type="text" placeholder="PRODUCT DISCOUNT" class="validate form-control" require>
                        </div>

                        <div class="form-group col-md-4">
                            <label for="quantity">QUANTITY</label>
                            <input id="quantity" name="product[productQty]" value="<?php echo $product->productQty ?>" type="text" placeholder="PRODUCT QUANTITY" class="validate form-control" require>
                        </div>
